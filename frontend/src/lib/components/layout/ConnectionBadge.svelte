...
-->
<script lang="ts">
  import { connectionStatus, connectionLabel, connectionColorClass, healthData, lastHealthCheck } from '$lib/stores/connection';
...
<div class="flex items-center gap-2 px-3 py-1.5 rounded-full bg-muted/50 hover:bg-muted transition-colors cursor-default" title={tooltipText}>
  <!-- Animated dot -->
